...
const FileItem=({initialFileName, file , index , onDelete})=>{

    const prevName=initialFileName;
                ...
                <div className="bg-background w-full h-screen flex items-center justify-center">
                    <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                        <div className="flex flex-row justify-between">
                            <h1 className="text-2xl font-bold mb-4 text-start">Edit File Name</h1>
                        </div>
                        <p className="mb-2 text-start">File name</p>
                        <input
                        type="text"
                    ...
                    {(popupState) => (
                        <React.Fragment>
                            ...
                            <Menu {...bindMenu(popupState)}>
                                ...
                                <MenuItems onClick={()=>handleDownload(file)}>
                                    <DownloadIcon/>
                                    <span>Download</span>
                                </MenuItems>
